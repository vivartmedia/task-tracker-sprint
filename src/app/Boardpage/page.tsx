            ...
            <div className="flex min-h-screen flex-col p-24  bg-green-50">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <div className="container mx-auto p-4 bg-green-200	">
                        ...
                        <Card href="#" className="max-w-sm bg-white p-4 w-80">
                    ...
                    <div className="container mx-auto p-4  m-10  bg-green-300	">
                    ...
                    <div className="container mx-auto p-4  m-10  bg-green-400	">
